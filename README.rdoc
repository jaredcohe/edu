...
# search button bigger, remove header image
...
# add reviews
# add click on each resource to get to the resource page
...
# add to resource boxes a link to go to the external resource with target blank
